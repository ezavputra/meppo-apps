...
class RequestQuotationAdd extends Component {
  constructor(props) {
    super(props);
    ...
    try {
      if (this.state.product_selected.length == 0) {
        Toast.show({
          type: 'error',
          text1: 'Error',
          text2: "Item Purchase Request belum diisi",
          visibilityTime: 2000,
          position: 'bottom',
          bottomOffset: 150,
          // autoHide: false,
        ...
        let formData = {
          ...
          "rfq_details": this.state.product_selected,
          "user_id": me.id
        }
        ...
        const response = await axios.post("/request_quotation/save", formData, {
          headers: {
                ...
                {({ values, errors, touched, setFieldValue, setFieldTouched, handleSubmit }) => {
                  ...
                  return (
                    <View style={{ marginBottom: 200 }}>
                      ...
                      <Select2
                        // isSelectSingle
                        style={{ borderRadius: 5, marginBottom: 6 }}
                        colorTheme="blue"
                    ...
                    <View style={{
                      ...
                      <Text sx={glueAndroid.Global_textBaseBold}
                        ...
                        {this.state.product_selected.length == 0 ?
                          "Pilih Purchase Request" : this.state.product_selected.length + " Item Selected"}
                      </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(RequestQuotationAdd);