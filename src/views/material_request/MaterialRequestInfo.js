...
class MaterialRequestInfo extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: []
            ...
            <ScrollView>
              <View style={{ padding: 16 }}>
                ...
                {/* <View style={{ marginVertical: 8, marginTop: 12 }}>
                  ...
                  <Text sx={glueAndroid.Global_textBase}>
                    {params.item.last_update == null ? params.item.createdBy.name : params.item.last_update.name}
                  </Text>
                  <Text sx={glueAndroid.Global_textBase}>
...
export default connect(mapStateToProps, mapDispatchToProps)(MaterialRequestInfo);