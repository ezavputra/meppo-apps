...
class Curation extends Component {
  ...
  async fetchData() {
    try {
      const response = await axios.post("/curation");
      this.setState({
              ...
              return (
                <View style={{
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    ...
                    {me.role.id == 9 && item.document_status_id == 58 && (
                      <Pressable
                        // key={"materialreq" + index}
                        style={{
                          marginVertical: 5
                        ...
                        {({ pressed }) => {
                          return (
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                              <FileEditIcon size={20} color='black' />
                            </View>
                          )
                        }}
                      </Pressable>
                    )}
                    {me.role.id == 10 && item.document_status_id == 60 && (
                      <Pressable
                        // key={"materialreq" + index}
                        style={{
                          marginVertical: 5
...
export default connect(mapStateToProps, mapDispatchToProps)(Curation);